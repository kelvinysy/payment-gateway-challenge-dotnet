...
public class PaymentsControllerTests
{
        ...
        PaymentStatus status, int cardNumberLastFour)
    {
        ...
        _mockPaymentProcessor.Setup(x => x.ProcessPayment(request)).ReturnsAsync(new PostPaymentResponse
        {
            Id = id,
            Status = status,
        ...
        // Assert
        _mockPaymentProcessor.Verify(x => x.ProcessPayment(request), Times.Once);
    ...
    public async Task PostPaymentAsync_ReturnsPaymentResponse_WhenGivenValidCurrency(string currencyCode,
        PostPaymentRequest request, PaymentStatus status, int cardNumberLastFour)
    {
        // Arrange
        ...
        _mockPaymentProcessor.Setup(x => x.ProcessPayment(request)).ReturnsAsync(postPaymentResponse);
        ...
        PostPaymentRequest request)
    {
        ...
        // Assert
        _mockPaymentProcessor.Verify(x => x.ProcessPayment(It.IsAny<PostPaymentRequest>()), Times.Never);
